...
@section('content')
    <h1 class="modal-title fw-bolder text-center" id="modal-add-label">Add a new room</h1>

    <form action="{{ route('room.store') }}" method="POST" style="width: 700px; margin: auto;" enctype="multipart/form-data">
        @csrf
        <div class="mb-3 fs-4">
